...
export default function AwardApp({ Component, pageProps }) {
  ...
  const NavItems = [
    ...
    },
    {
      ...
      href: "https://discord.com/invite/dTUr58ZVCp",
    },
    {
      link: true,
      name: "Botu Ekle",
      ...
      href: "https://discord.com/oauth2/authorize?client_id=1026857529545855047&scope=bot%20applications.commands&permissions=2146958847",
    },
       {
      link: true,
      name: "Oyla",
      ...
      href: "https://galaxykedy.vercel.app/vote",
    },
    {
      link: true,
      name: "Ortaklar",
